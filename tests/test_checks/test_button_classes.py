            ...
            [
                {
                    ...
                    "description": "`oe_highlight` button class is deprecated since v12.0 in favor of `btn-primary`",
                ...
                {
                    "slug": "deprecated_button_class",
                    "description": "`oe_link` button class is deprecated since v12.0 in favor of `btn-link`",
